        ...
        <div className="space-y-12">
          ...
          <div className="overflow-x-auto mb-4">
            <table className="w-full border-collapse border border-gray-600">
              ...
              <tbody>
                <tr>
                  <td className="border border-gray-600 px-4 py-2 text-white"><strong>Community Rewards</strong></td>
                  <td className="border border-gray-600 px-4 py-2 text-white">50%</td>
                  <td className="border border-gray-600 px-4 py-2 text-white">Distributed via a <strong>points-based system</strong> during Phase 0, based on participation in strategies</td>
                </tr>
                <tr>
                  <td className="border border-gray-600 px-4 py-2 text-white"><strong>Liquidity Mining</strong></td>
                  <td className="border border-gray-600 px-4 py-2 text-white">50%</td>
                  <td className="border border-gray-600 px-4 py-2 text-white">Rewards for users providing liquidity into the <strong>Ignition Core</strong>, funding the primary pool at TGE (see below)</td>
                </tr>
              </tbody>
            </table>
          </div>
