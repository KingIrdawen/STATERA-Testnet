      ...
      <div className="prose prose-invert max-w-none">
        <div className="space-y-12">
          <section>
            ...
            <h2 className="text-2xl font-bold text-white mb-6 mt-8">How to participate:</h2>
            <ol className="text-[#5a9a9a] leading-relaxed ml-6 space-y-2 list-decimal">
            ...
            <h2 className="text-2xl font-bold text-white mb-6 mt-8">Key advantages:</h2>
            <ul className="text-[#5a9a9a] leading-relaxed ml-6 space-y-2">
            ...
            <h2 className="text-2xl font-bold text-white mb-6 mt-8">Withdrawing funds:</h2>
          <p className="text-[#5a9a9a] leading-relaxed mb-4">
            ...
            <h2 className="text-2xl font-bold text-white mb-6 mt-8">Pricing of the liquid token:</h2>
            <ul className="text-[#5a9a9a] leading-relaxed ml-6 space-y-2">
