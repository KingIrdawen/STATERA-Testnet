      ...
      <div className="prose prose-invert max-w-none">
        <div className="space-y-12">
          ...
          <p className="text-white leading-relaxed mb-4">
            ...
            <h3 className="text-xl font-bold text-[#C9A36A] mb-4 mt-6">Entry fees: 0.5%</h3>
            <ul className="text-white leading-relaxed ml-6 space-y-2 mb-6">
            ...
            <h3 className="text-xl font-bold text-[#C9A36A] mb-4 mt-6">Exit fees: 0.5%</h3>
            <ul className="text-white leading-relaxed ml-6 space-y-2 mb-6">
            ...
            <h3 className="text-xl font-bold text-[#C9A36A] mb-4 mt-6">Management fees: 0.95% per year</h3>
            <ul className="text-white leading-relaxed ml-6 space-y-2 mb-6">
            ...
            <h3 className="text-xl font-bold text-[#C9A36A] mb-4 mt-6">External fees:</h3>
            <ul className="text-white leading-relaxed ml-6 space-y-2">
